...
const WhyChoose = () => {
    return (
        <section >
            ...
            <div className='section-container my-24 grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-8 items-center text-left'>

                <div>
                    <h2 className='text-4xl font-bold leading-tight'>Why <br />Choosing Us</h2>
                </div>
